<!-- ============================================================
     METADATA (copy into WordPress fields)
     ============================================================
     Title:       Agents as Code: A Cluster Admin's Diary
     Author:      Pavel Anni
     Tags:        openshift, ai, agents, gitops, kubernetes, argo-cd
     Category:    AI / Cloud-Native
     Description: A cluster admin deploys AI assistants for a power
                  user, a marketing team, three departments, and a
                  locked-down contractor — all as Kubernetes
                  resources managed through GitOps.

     Hero image brief (1900x800):
       A split-screen terminal view: on the left, a dark terminal
       showing a "git push" command completing; on the right, an
       OpenShift cluster dashboard with multiple agent pods
       appearing and turning green — the visual metaphor of
       "push YAML, agents appear."
     ============================================================ -->
